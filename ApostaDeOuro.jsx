...
import { Gift, Star, Trophy, Send } from "lucide-react";

export default function ApostaDeOuro() {
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-gradient-to-b from-yellow-100 to-yellow-50 min-h-screen">
      {/* Header */}
      <h1 className="text-4xl font-extrabold text-yellow-800 mb-6 text-center">
        Aposta de Ouro ✨
      </h1>
      <p className="text-lg text-yellow-700 mb-10 text-center max-w-xl">
        Onde os teus sonhos se transformam em vitórias!
      </p>
